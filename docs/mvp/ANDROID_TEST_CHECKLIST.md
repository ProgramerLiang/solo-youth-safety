...
- [ ] debug 输出文件名包含版本号，例如 `solo-youth-safety-v0.2.8-debug.apk`
- [ ] release 输出文件名包含版本号，例如 `solo-youth-safety-v0.2.8-release.apk`
- [ ] release AAB 输出文件名包含版本号，例如 `solo-youth-safety-v0.2.8-release.aab`

...
- “守护”页已支持“轨迹守护”：
  ...
  - **边界说明**：当前仅保证 **前台 / 应用仍存活期间** 的周期采样与补发；**不承诺** Android 长时后台保活、Doze 下持续运行、被系统杀死后持续追踪，也**不表示已经具备前台服务长期运行方案**
- 联系人已独立为单独页面，支持：
  - 新增联系人
  - 编辑联系人
  - 删除联系人
...
## 8) 真机行为说明
> P0-3 统一边界摘要：当前前端 / Android 侧已落地的守护相关能力，仅限 **前台 / 应用存活期间的周期采样 + 本地补发 + 手动 SOS**。当前**不承诺** Android 长时后台保活、Doze 下持续运行、被系统杀死后持续追踪、前台服务长期运行方案、自动报警 / 围栏 / 异常检测 / 正式应急平台。
